...
dataset['TIME_TO_PARADE_1'].fillna(1000000, inplace=True)
dataset['TIME_TO_PARADE_2'].fillna(1000000, inplace=True)
dataset['TIME_TO_NIGHT_SHOW'].fillna(1000000, inplace=True)
